...
drwxr-xr-x   6 user  staff   192 Jan 15 14:30 ..`,
	...
	{
		Name:           "rate_limit_docs_prose",
		Content:        "Document API rate limits in the README and add examples.",
		Tool:           "claude",
		ShouldMatch:    false,
		ExpectedReason: "no_match",
	},
	{
		Name:           "rate_limiter_implementation_prose",
		Content:        "Refactor the rate limiter implementation and add tests.",
		Tool:           "codex",
		ShouldMatch:    false,
		ExpectedReason: "no_match",
	},
	{
		Name:           "bare_429_fixture_prose",
		Content:        "Unit test fixture for HTTP 429 responses.",
		Tool:           "gemini",
		ShouldMatch:    false,
		ExpectedReason: "no_match",
	},
	{
		Name:           "too_many_requests_docs_prose",
		Content:        "HTTP 429 Too Many Requests fixture for integration tests.",
		Tool:           "claude",
		ShouldMatch:    false,
		ExpectedReason: "no_match",
	},
	{
		Name:           "quota_configuration_prose",
		Content:        "Loaded quota limit configuration from project settings.",
		Tool:           "gemini",
		ShouldMatch:    false,
		ExpectedReason: "no_match",
	},
	{
		Name:           "capacity_planning_prose",
		Content:        "Capacity planning notes: add two more workers next week.",
		Tool:           "claude",
		ShouldMatch:    false,
		ExpectedReason: "no_match",
	},
